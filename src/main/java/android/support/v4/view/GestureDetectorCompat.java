            ...
            switch (action & 255) {
                ...
                case 1:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        velocityTracker.computeCurrentVelocity(BmobConstants.TIME_DELAY_RETRY, (float) this.mMaximumFlingVelocity);
                ...
                case 6:
                    ...
                    this.mLastFocusY = focusY;
                    this.mDownFocusY = focusY;
                    this.mVelocityTracker.computeCurrentVelocity(BmobConstants.TIME_DELAY_RETRY, (float) this.mMaximumFlingVelocity);
