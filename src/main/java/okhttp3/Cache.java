...
public final class Cache implements Closeable, Flushable {
    ...
    private static final class Entry {
        ...
        public void writeTo(Editor editor) throws IOException {
            ...
            sink.writeUtf8(OkHeaders.SENT_MILLIS).writeUtf8(": ").writeDecimalLong(this.sentRequestMillis).writeByte(10);
            sink.writeUtf8(OkHeaders.RECEIVED_MILLIS).writeUtf8(": ").writeDecimalLong(this.receivedResponseMillis).writeByte(10);
            if (isHttps()) {
                sink.writeByte(10);
    ...
    private CacheRequest put(Response response) throws IOException {
        ...
        } else if (!requestMethod.equals(HttpGet.METHOD_NAME) || OkHeaders.hasVaryAll(response)) {
            return null;
        } else {
