...
public class Completable {
    ...
    public static Completable merge(Observable<? extends Completable> sources) {
        return merge0(sources, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, false);
    }
    ...
    public static Completable mergeDelayError(Observable<? extends Completable> sources) {
        return merge0(sources, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, true);
    }
    ...
    public final <T> Observable<T> endWith(Observable<T> next) {
        return andThen((Observable) next);
    }
    ...
    public final Completable lift(final CompletableOperator onLift) {
        ...
        return create(new CompletableOnSubscribe() {
            public void call(CompletableSubscriber s) {
                try {
                    Completable.this.unsafeSubscribe((CompletableSubscriber) Completable.HOOK.onLift(onLift).call(s));
                } catch (NullPointerException ex) {
                    throw ex;
                } catch (Throwable ex2) {
    ...
    public final void unsafeSubscribe(CompletableSubscriber s) {
        requireNonNull(s);
        try {
            HOOK.onSubscribeStart(this, this.onSubscribe).call(s);
        } catch (NullPointerException ex) {
            throw ex;
        } catch (Throwable ex2) {
            Exceptions.throwIfFatal(ex2);
            Throwable ex22 = HOOK.onSubscribeError(ex22);
            ERROR_HANDLER.handleError(ex22);
